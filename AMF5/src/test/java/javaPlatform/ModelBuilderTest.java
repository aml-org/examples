...
public class ModelBuilderTest {
    ...
    public void buildWebApiTest() throws ExecutionException, InterruptedException {
        ...
        // add get operation
        final Operation meGet = (Operation) me.withOperation("get").withDescription("Get Current User's Profile");
        ...
        final Operation playlistsGet = (Operation) playlists.withOperation("get")
        ...
        final Payload payload = (Payload) new Payload().withMediaType("application/json");
        payload.withScalarSchema("schema").withDataType(stringDataType);
        final Parameter marketQueryParam = (Parameter) marketRequest.withQueryParameter("market")
                .withRequired(false)
                .withName("Market")
